...
def process_mesh_with_geometry(original_mesh_id, offset_lowest,lod):
    ...
    new_mesh_2 = rs.coercemesh(new_mesh_id,True)
    quad_mesh = QuadRemesh_LOD(new_mesh_2,lod) # chuyen mesh_id thanh Mesh
...
if __name__ == "__main__":
    ...
    if original_mesh_id:
        ...
        if vertices:
            ...
            process_mesh_with_geometry(original_mesh_id, offset_lowest,lod)
    rs.EnableRedraw(True)
    print("Completed!")